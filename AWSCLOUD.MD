...
Get the IODC Provider and maintain the draft_irsa-trust-policy copy.json 
...
```bash
kubectl get po -n support-ops-agent
```

```
eksctl delete cluster --name=support-ops-demo

```

## Reach the API from your laptop (class demo curls)
